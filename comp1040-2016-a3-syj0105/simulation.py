...
def animate_events(fnum, e, positions):
    ...
    # TODO: Implement code here for the final task of the assignment. You may
    ...
    plt.subplot(1, 4, 4)  # plot message longevity in the fourth subplot
    plt.cla()
    width = 0.65
